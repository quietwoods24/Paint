...
namespace Paint
{
    public partial class MainForm : Form
    {
        ...
        private void button_Rand_Triangle_Click(object sender, EventArgs e)
        {
            if (CurrImage == null)
                return;
            ...
            Point2D[] points = TestCode.GenerateRandomShape(3, h);
            var polygon = new Polygon(points);
            polygon.rotationAngle = phi;
            polygon.Rotation(phi);
            polygon.StrokeColor = strokeColor;
            polygon.FillColor = fillColor;
            polygon.StrokeWidth = strokeWidth;
            CurrImage.Add(polygon);
        ...
        private void button_Rand_Pentagon_Click(object sender, EventArgs e)
        {
            if (CurrImage == null)
                return;
            ...
            Point2D[] points = TestCode.GenerateRandomShape(5, h);
            var polygon = new Polygon(points);
            polygon.rotationAngle = phi;
            polygon.Rotation(phi);
            polygon.StrokeColor = strokeColor;
        ...
        private void button_Rand_Hexagon_Click(object sender, EventArgs e)
        {
            if (CurrImage == null)
                return;
            ...
            Point2D[] points = TestCode.GenerateRandomShape(6, h);
            var polygon = new Polygon(points);
            polygon.rotationAngle = phi;
            polygon.Rotation(phi);
            polygon.StrokeColor = strokeColor;
        ...
        private void button_Rand_Quadrilateral_Click(object sender, EventArgs e)
        {
            if (CurrImage == null)
                return;
            ...
            Point2D[] points = TestCode.GenerateRandomShape(4, h);
            var polygon = new Polygon(points);
            polygon.rotationAngle = phi;
            polygon.Rotation(phi);
            polygon.StrokeColor = strokeColor;
        ...
        private void button_Rectangle_Click(object sender, EventArgs e)
        {
            ...
            var rectangle = new Rand_Rectangle(rnd.Next(w), rnd.Next(h), rnd.Next(w), rnd.Next(w));
            rectangle.rotationAngle = phi;
            rectangle.Rotation(phi);
        ...
        private void numericUpDownAngle_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (CurrImage != null) { 
                if (CurrImage.selectedShape != null) { 
                    ...
                    CurrImage.selectedShape.Rotation(phi);
                    panelDraw.Refresh();
                }
            }
        }
